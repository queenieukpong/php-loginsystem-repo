        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php">
                    <strong><span>AGIT</span> CodeWorks</strong>
                </a>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-10">
                                <h1 class="slick-title">AGIT CodeWorks</h1>

                                <p class="lead text-white mt-lg-3 mb-lg-5">AGIT CodeWorks template comes with total 8 HTML pages provided by Tooplate website.</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-10">
                                ...
                                <p class="lead text-white mt-lg-3 mb-lg-5">Please share this AGIT CodeWorks template to your friends. Thank you for supporting us.</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-12">
                                        <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                            ...
                                            <p>AGIT CodeWorks templates comes with <a href="sign-in.php">sign in</a> / <a href="sign-up.php">sign up</a> pages, product listing / product detail, about, FAQs, and contact page.</p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="px-5 py-5 py-lg-0">
                            ...
                            <p class="lead mb-4">Credits go to Unsplash and FreePik websites for images used in this AGIT CodeWorks by Tooplate.</p>
